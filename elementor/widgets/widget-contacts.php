...
// contacts
class thegncy_Widget_Contacts extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Contacts', 'thegncy' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'contacts_section',
         [
            'label' => esc_html__( 'contacts Section', 'thegncy' ),
      ...
      $repeater1->add_control(
         'contact_icon', [
            'label' => __( 'Contact Icon', 'thegncy' ),
            'type' => \Elementor\Controls_Manager::MEDIA
         ]
      );
      $repeater1->add_control(
         'contact_title', [
            'label' => __( 'Contact Title', 'thegncy' ),
            'type' => \Elementor\Controls_Manager::TEXT
         ]
      );
      $repeater1->add_control(
         'contact', [
            'label' => __( 'Contact', 'thegncy' ),
            'type' => \Elementor\Controls_Manager::TEXT
         ]
      );
      ...
      $this->add_control(
         'contacts_list',
         [
            'label' => __( 'Contacts List', 'thegncy' ),
      ...
      <div class="contacts"> 
         ...
         <ul>
            <li class="list-inline-item">
               <?php echo esc_html__( "Social media :" , 'thegncy' ); ?>
            </li>
...
Plugin::instance()->widgets_manager->register_widget_type( new thegncy_Widget_Contacts );